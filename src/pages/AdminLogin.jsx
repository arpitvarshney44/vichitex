      ...
      <div className="relative z-10 flex flex-col justify-center py-12 sm:px-6 lg:px-8 pt-24">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="text-center animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            <h2 className="mt-8 text-4xl font-bold text-gray-900 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              Admin Access
            </h2>
            <p className="mt-3 text-lg text-gray-600 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              Sign in to manage tests and student progress
            </p>
          </div>
        </div>

        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
