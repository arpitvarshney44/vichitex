...
import { FaEnvelope, FaArrowRight, FaCheckCircle, FaLock, FaShieldAlt, FaUserShield } from 'react-icons/fa'
            ...
            {status === 'form' && (
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="text-center">
                  <Link
                    to="/login"
                    className="group inline-flex items-center text-sm text-blue-600 hover:text-blue-700 font-medium transition-colors duration-300"
                  >
        ...
        <div className={`mt-12 sm:mx-auto sm:w-full sm:max-w-2xl animate-fade-in-up ${isVisible ? 'animate-slide-in-up' : ''}`} style={{ animationDelay: '0.9s' }}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center justify-center space-x-2 bg-white/60 backdrop-blur-sm p-3 rounded-xl border border-white/20">
              ...
              <span className="text-sm font-medium text-gray-700">Account Protection</span>
            </div>
            <div className="flex items-center justify-center space-x-2 bg-white/60 backdrop-blur-sm p-3 rounded-xl border border-white/20">
